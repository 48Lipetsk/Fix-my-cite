<?php
/**
 * PATCHED twig.php for OpenCart 3.0.4.1-rs
 * 
 * FIX: Replaced ArrayLoader with ChainLoader (ArrayLoader + FilesystemLoader)
 * to support {% include %} directives in Twig templates.
 * 
 * Without this fix, modules like OCFilter that use {% include %} in their
 * templates cause 400 errors because ArrayLoader cannot resolve file paths.
 * 
 ...
 * 
 * REPLACED WITH: ChainLoader combining ArrayLoader + FilesystemLoader
 */
namespace Template;
final class Twig {
	private $data = array();
