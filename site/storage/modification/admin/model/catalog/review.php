...
class ModelCatalogReview extends Model {
	public function addReview($data) {
		...
		//prostore
		$this->db->query("INSERT INTO " . DB_PREFIX . "review_extls SET review_id = '" . (int)$review_id . "', text_plus  = '" . $this->db->escape($data['text_plus']) . "', text_minus = '" . $this->db->escape($data['text_minus']) . "', text_admin_answer = '" . $this->db->escape($data['text_admin_answer']) . "', answer_date_added = NOW() ");
		// prostore end	
	...
	public function editReview($review_id, $data) {
		...
		//prostore
		$sql = "UPDATE " . DB_PREFIX . "review_extls SET review_id = '" . (int)$review_id . "', text_plus  = '" . $this->db->escape($data['text_plus']) . "',";
		$sql .= " text_minus = '" . $this->db->escape($data['text_minus']) . "', text_admin_answer = '" . $this->db->escape($data['text_admin_answer']) . "'";
	...
	public function deleteReview($review_id) {
		...
		//prostore
		$this->db->query("DELETE FROM " . DB_PREFIX . "review_extls WHERE review_id = '" . (int)$review_id . "'");
		// prostore end	
