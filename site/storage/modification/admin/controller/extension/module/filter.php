...
//prostore start
		if (isset($this->request->post['module_filter_filter_grouptype'])) {
			$data['module_filter_filter_grouptype'] = $this->request->post['module_filter_filter_grouptype'];
		} elseif($this->config->get('module_filter_filter_grouptype')) {
			$data['module_filter_filter_grouptype'] = $this->config->get('module_filter_filter_grouptype');
		}else{
			$data['module_filter_filter_grouptype'] = 0;
		}
//prostore stop
