...
class ControllerCatalogCategory extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->clearCache(); // prostore added this
...
// prostore start
	  public function clearCache() { //Clear Cache for Menu
		$this->cache->delete('category.categoriesdata');
		$this->cache->delete('category.categoriestopcat');
		$this->cache->delete('prostore.category');
		$this->cache->delete('navview');
		$this->cache->delete('navviewmobi');
	  }
// prostore end	
