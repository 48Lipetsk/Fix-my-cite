	...
	protected function validateCopy() {
		...
		return !$this->error;
			  ...
			  public function changePrice(){
				  ...
				  if(!isset($this->request->post['product_id']) || !isset($this->request->post['new_price']) || !isset($this->request->post['price_type'])){
					  $json['error'] = 'Not enough data!';
				  }

				  if(!isset($json['error'])){
					  $data = $this->request->post;
					  $this->model_catalog_product->changePrice($data['product_id'], $data['new_price'], $data['price_type']);

					  $json['new_price_val'] = $data['new_price'];
					  $json['new_price'] = $this->currency->format($data['new_price'], $this->config->get('config_currency'));
					  $json['success'] = true;
				  }
