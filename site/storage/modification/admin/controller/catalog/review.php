...
//prostore
		...
		$data['entry_text_plus'] = $this->language->get('entry_text_plus');
		$data['entry_text_minus'] = $this->language->get('entry_text_minus');

		$this->load->model('extension/theme/prostore');
		if (isset($this->request->get['review_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$review_extr_info = $this->model_extension_theme_prostore->getExtrReview($this->request->get['review_id']);
		}

	    if (isset($this->request->post['text_plus'])) {
	      $data['text_plus'] = $this->request->post['text_plus'];
	    } elseif (!empty($review_extr_info)) {
	      $data['text_plus'] = $review_extr_info['text_plus'];
	    } else {
	      $data['text_plus'] = '';
	    }
	    if (isset($this->request->post['text_minus'])) {
	      ...
	      $data['text_minus'] = $review_extr_info['text_minus'];
	    } else {
	      $data['text_minus'] = '';
	    }
	    if (isset($this->request->post['text_admin_answer'])) {
			...
			$data['text_admin_answer'] = $review_extr_info['text_admin_answer'];
		  } else {
