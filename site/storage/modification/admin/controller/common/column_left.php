...
// prostore
			...
			if ($this->user->hasPermission('access', 'extension/theme/prostore')) {
				...
				if ($stores) {
					...
					$prostore[] = array(
						'name'	   => $this->language->get('text_theme_prostore'),
						'href'     => $this->url->link('extension/theme/prostore', 'user_token=' . $this->session->data['user_token'] . '&store_id=0', true),
						'children' => array()		
					);// fix collapse1 bug
					
					$prostore_store = array();
					...
					foreach ($stores as $store) {
						$prostore_store[] = array(
							...
							'href'     => $this->url->link('extension/theme/prostore', 'user_token=' . $this->session->data['user_token'] . '&store_id=' . $store['store_id'], true),
							'children' => array()	
						);
					}
					...
					if ($prostore_store) {		
						$prostore[] = array(
							'name'	   => $this->language->get('text_theme_prostore_store'),
							'href'     => '',
							'children' => $prostore_store		
						);					
					}
			...
			if ($this->user->hasPermission('access', 'extension/module/prostore/callback')) {
				$this->load->model('extension/theme/callback');
				$callbacks_new = $this->model_extension_theme_callback->getCallbackNew();

				$callbacks_new = $callbacks_new['total'];				
				$prostore[] = array(
					'name'	   => $this->language->get('text_callback') . ($callbacks_new > 0 ? ' <span class="badge">' . $callbacks_new . '</span>' : ''),
					'href'     => $this->url->link('extension/module/prostore/callback', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'extension/module/prostore/found_cheaper')) {
				$this->load->model('extension/theme/found_cheaper');
				$callcheapers_new = $this->model_extension_theme_found_cheaper->getCallCheaperNew();	

				$prostore[] = array(
					'name'	   => $this->language->get('text_foundcheaper') . ($callcheapers_new > 0 ? ' <span class="badge">' . $callcheapers_new . '</span>' : ''),
					'href'     => $this->url->link('extension/module/prostore/found_cheaper', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			if ($this->user->hasPermission('access', 'extension/module/prostore/prostore_faq')) {
				$this->load->model('extension/theme/prostore_faq');
				$callFaq_new = $this->model_extension_theme_prostore_faq->getTotalNewFaqs();
									
				$prostore[] = array(
					'name'	   => $this->language->get('text_prostore_faq') . ($callFaq_new > 0 ? ' <span class="badge">' . $callFaq_new . '</span>' : ''),
					'href'     => $this->url->link('extension/module/prostore/prostore_faq', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}	
			if ($this->user->hasPermission('access', 'extension/module/prostore_review_shop')) {
				$this->load->model('extension/theme/prostore_review_shop');
				$shopReviews_new = $this->model_extension_theme_prostore_review_shop->getTotalNewReviews();					
				$prostore[] = array(
					'name'	   => $this->language->get('text_prostore_review_shop') . ($shopReviews_new > 0 ? ' <span class="badge">' . $shopReviews_new . '</span>' : ''),
					'href'     => $this->url->link('extension/module/prostore_review_shop/show', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}						
			if ($this->user->hasPermission('access', 'extension/module/prostore/subscribe')) {
				$prostore[] = array(
					'name'	   => $this->language->get('text_subscribe'),
					'href'     => $this->url->link('extension/module/prostore/subscribe', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}

			if ($this->user->hasPermission('access', 'extension/module/prostore/prostore_sets')) {		
				$prostore[] = array(
					'name'	   => $this->language->get('text_prostore_sets'),
					'href'     => $this->url->link('extension/module/prostore/prostore_sets', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}			
			if ($this->user->hasPermission('access', 'extension/module/prostore/prostore_news')) {		
				$prostore[] = array(
					'name'	   => $this->language->get('text_prostore_news'),
					'href'     => $this->url->link('extension/module/prostore/prostore_news', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}
			if ($this->user->hasPermission('access', 'extension/module/prostore/prostore_tab')) {		
				$prostore[] = array(
					'name'	   => $this->language->get('text_prostore_tab'),
					'href'     => $this->url->link('extension/module/prostore/prostore_tab', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/prostore/prostore_blog')) {
				$this->load->model('extension/theme/prostoreblog');
				$comments_new = $this->model_extension_theme_prostoreblog->getCommentNewCount(); 
				$comments_new = $comments_new['total'];

				$blog[] = array(
					'name'     => $this->language->get('text_prostore_blog'),
					'href'     => $this->url->link('extension/module/prostore/prostore_blog', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()	
				);
			}
			
			if ($this->user->hasPermission('access', 'extension/module/prostore/prostorecat_blog')) {
				$blog[] = array(
					'name'	   => $this->language->get('text_prostorecat_blog'),
					'href'     => $this->url->link('extension/module/prostore/prostorecat_blog', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($this->user->hasPermission('access', 'extension/module/prostore/prostore_blog_banner')) {
				$blog[] = array(
					'name'	   => $this->language->get('text_prostore_blog_banner'),
					'href'     => $this->url->link('extension/module/prostore/prostore_blog_banner', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			if ($this->user->hasPermission('access', 'extension/module/prostore/prostoreblog_review')) {
				$blog[] = array(
					'name'	   => $this->language->get('text_prostoreblog_review') . ($comments_new > 0 ? ' <span class="badge">' . $comments_new . '</span>' : ''),
					'href'     => $this->url->link('extension/module/prostore/prostoreblog_review', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($blog) {		
				$prostore[] = array(
					'name'	   => $this->language->get('text_prostore_blog_main') . ($comments_new > 0 ? ' <span class="badge">' . $comments_new . '</span>' : ''),
					'href'     => '',
					'children' => $blog		
				);					
			}
			...
			if ($prostore) {
				$prostore_alerts = $comments_new+$callbacks_new+$callFaq_new+$callcheapers_new;
				if (isset($shopReviews_new)) {
					$prostore_alerts += $shopReviews_new;
				}

				$data['menus'][] = array(
					'id'       => 'menu-prostore',
					'icon'	   => 'prostore', 
					'name'	   => $this->language->get('text_prostore') . ($prostore_alerts > 0 ? ' <span class="badge">' . $prostore_alerts . '</span>' : ''),
					'href'     => '',
					'children' => $prostore
				);		
			}
