...
$this->load->model('tool/image'); // prostore, oc 3.0.3.7 fix
$data['brands_img'] = $this->config->get('theme_prostore_brands_img');
...
$data['column_left']  = $this->load->controller('common/column_left');
	...
	public function info() {
		...
		$data['language_id'] = $this->config->get('config_language_id'); //prostore added this		
...
//prostore stop			
			...
			if ($page < $num_pages) {
				$data['nextPageUrl'] = $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $this->request->get['manufacturer_id'] .  $url . '&page='.($page+1) );
			}
//prostore stop	
