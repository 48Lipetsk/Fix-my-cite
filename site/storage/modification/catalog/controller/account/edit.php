...
//prostore start
		...
		$activeFields = $this->model_extension_module_prostore->getFields($this->config->get('config_customer_group_id'),1);
...
//prostore start
		...
		$ignoredFields = $this->model_extension_module_prostore->getIgnoredFields($this->config->get('config_customer_group_id'),1);
		if(isset($this->error)){
