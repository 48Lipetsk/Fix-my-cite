...
$data['heading_title'] = $this->language->get('heading_title');// Prostore
...
//prostore start
		...
		$activeFields = $this->model_extension_module_prostore->getFields($this->config->get('config_customer_group_id'),0);
		...
		foreach($activeFields as $field){
			...
			$data['entry_'.$field['name'].'_id'] = 'ls-'.$field['custom_field_id'];
			$data['entry_'.$field['name'].'_required'] = $field['required'];
			$data['entry_'.$field['name'].'_show'] = $field['is_show'];
		}
		$data['entry_email_show'] = 0;
		$data['entry_fax_show'] = 0;
		$data['entry_telephone_show'] = 0;//не должно быть в адресе
//prostore end
...
//prostore start				
		$this->load->model('extension/module/prostore');
		$this->error = $this->model_extension_module_prostore->checkLCustomFields($this->error);
		$ignoredFields = $this->model_extension_module_prostore->getIgnoredFields($this->config->get('config_customer_group_id'),0);
