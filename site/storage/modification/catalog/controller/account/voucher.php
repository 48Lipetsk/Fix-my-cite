...
class ControllerAccountVoucher extends Controller {
	...
	public function index() {
		...
		// prostore
		if ($this->config->get('theme_prostore_voucher_pdata')) {
			$this->load->language('extension/theme/prostore');
			$this->load->model('catalog/information');

			$information_info = $this->model_catalog_information->getInformation($this->config->get('theme_prostore_voucher_pdata'));

			if ($information_info) {
				$data['text_prostore_pdata_checkbox'] = sprintf($this->language->get('text_prostore_pdata_checkbox'), $this->url->link('information/information/agree', 'information_id=' . $this->config->get('theme_prostore_voucher_pdata'), true), $information_info['title'], $information_info['title']);
			} else {
				$data['text_prostore_pdata_checkbox'] = '';
			}
		} else {
			$data['text_prostore_pdata_checkbox'] = '';
		}
	...
	protected function validate() {
		...
		if ($this->config->get('theme_prostore_voucher_pdata')) {
			...
			if ($information_info && !isset($this->request->post['pdata'])) {
				$this->error['error_pdata'] = sprintf($this->language->get('text_prostore_error_pdata'), $information_info['title']);
			}
		}
		// prostore end
