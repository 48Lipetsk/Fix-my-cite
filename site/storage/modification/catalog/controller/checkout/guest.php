...
//prostore start
		...
		$activeFields = $this->model_extension_module_prostore->getFields($data['customer_group_id']);
...
//prostore start				
		...
		$ignoredFields = array();
		if($this->model_extension_module_prostore->getIgnoredFields($customer_group_id)){
			$ignoredFields = $this->model_extension_module_prostore->getIgnoredFields($customer_group_id);
		}
