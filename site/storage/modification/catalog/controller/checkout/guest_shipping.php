...
//prostore start
		...
		$activeFields = $this->model_extension_module_prostore->getFields($this->session->data['guest']['customer_group_id']);
...
//prostore start				
		...
		$ignoredFields = $this->model_extension_module_prostore->getIgnoredFields($this->session->data['guest']['customer_group_id']);
		if(isset($json['error'])){
