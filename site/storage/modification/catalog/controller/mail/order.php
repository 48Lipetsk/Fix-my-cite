...
// prostore
		if ($order_info['comment']) {
			$data['customer_comment'] = strip_tags($order_info['comment']);
		}
// prostore end
...
// prostore end
			...
			$data['products'][] = array(
				...
				'image'	=> $image,// prostore
				'href'	 => $this->url->link('product/product', 'product_id=' . $order_product['product_id']),// prostore
		...
		$mail->setTo($order_info['email']);
				...
				//prostore start
				if(!$order_info['email']){
					$mail->setTo('nomailprostores@nomail.ru');
				}
				//prostore stop
...
if (
	!in_array($order_status_id, $this->config->get('config_processing_status')) &&
